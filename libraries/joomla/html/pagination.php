...
class JPagination extends JObject
{
	...
	protected function _buildDataObject()
	{
		...
		$data->start = new JPaginationObject(JText::_('<<'), $this->prefix);
		$data->previous = new JPaginationObject(JText::_('<'), $this->prefix);
		...
		$data->next = new JPaginationObject(JText::_('>'), $this->prefix);
		$data->end = new JPaginationObject(JText::_('>>'), $this->prefix);
