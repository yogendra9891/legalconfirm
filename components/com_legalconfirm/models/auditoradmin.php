...
//		}
	...
	protected function getListQuery() {
		...
		//get employy
		$query = "SELECT a.*,b.lid,b.accounting_firm,b.emp_title,b.phone,d.office_title 
		...
		$query1 = "Select a.*,c.lid,c.accounting_firm,c.emp_title,c.phone,e.empid,d.gid 
		          FROM  #__users as a ,
		               #__user_usergroup_map as b,
		               #__users_profile_detail as c,
		               #__users_office as d,
		               #__employee_office as e"
		          ." WHERE a.id = b.user_id AND b.group_id = ".$db->escape($auditor_emp,true)." 
		            AND c.lid=a.id AND a.id = e.empid AND a.email like '%".$firm_name."%'";
