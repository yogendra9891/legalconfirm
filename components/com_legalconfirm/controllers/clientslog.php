 ...
 */
class LegalconfirmControllerClientslog extends LegalconfirmController
{
	 ...
	 * @since	1.6
	 */
	public function &getModel($name = 'Clientslog', $prefix = 'LegalconfirmModel')
	{
	...
	public function generatepdf()
	{
		...
		$pdf->SetHeaderData('logo.png', '40', 'Legal Confirm', 'by LLC');
