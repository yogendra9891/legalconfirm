...
<tr id="adminformclass" class="attorney-pending-logs-class">
				...
				<th>
				<?php echo JHtml::_('grid.sort', 'COM_LEGALCONFIRM_LAWFIRM_LOGS_RESPONSETDATE', 'c.responsedate', $this->state->get('list.direction'),$this->state->get('list.ordering') ); ?>
				</th>
				
				<th>
				<?php echo JText::_('COM_LEGALCONFIRM_LAWFIRM_LOGS_RESPONSE'); ?>
				</th>
</tr>
