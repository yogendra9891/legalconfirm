...
<div class="auditor-clientlogs-wrapper lawfirmlogs-pending" id="tab-container">
 ...
 <ul class='etabs'>
   ...
   <li class='tab client_profile'><a href="<?php echo JRoute::_('index.php?option=com_legalconfirm&view=lawfirmslog&id='.$clientid);?>"><?php echo JText::_('COM_LEGALCONFIRM_CLIENT_INITIATE');?></a></li>
...
<div class="client-proposal-logs"><?php echo JText::_('COM_LEGALCONFIRM_LAWFIRM_RESPONSES_LOGS_PENDING');?>
<!-- <div class="pending-received">
 <a href="<?php echo JRoute::_('index.php?option=com_legalconfirm&view=lawfirmslog&id='.$clientid);?>" class="attorney-logs-active"><?php echo JText::_('COM_LEGALCONFIRM_LAWFIRM_PENDING_LOGS'); ?><img src="<?php echo JURI::base().'templates/legalconfirm/images/pending_proposal.png'?>" alt="" title="pending proposals" style="padding-left: 2px; position: relative; top: 3px;"/></a>&nbsp;|&nbsp;
 <a href="<?php echo JRoute::_('index.php?option=com_legalconfirm&view=lawfirmsreceivedlog&id='.$clientid);?>"><?php echo JText::_('COM_LEGALCONFIRM_LAWFIRM_RESPONSED_LOGS'); ?><img src="<?php echo JURI::base().'templates/legalconfirm/images/received_proposal.png'?>" alt="edit" title="received proposals" style="padding-left: 2px; position: relative; top: 3px;" /></a>
 </div> -->
</div>
 <form action="<?php echo JRoute::_('index.php?option=com_legalconfirm&view=lawfirmslog&id='.$clientid);?>" name="adminForm" id="adminForm" method="post">
 	<div class="clr"> </div>
