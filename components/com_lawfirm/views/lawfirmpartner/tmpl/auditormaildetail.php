...
<link
	...
	type="text/css" />
<div class="register-box"><b>Auditor Request:</b><br /><br />
<?php
//echo "<pre>";
//print_r($this->item);
//die;
...
<a id="save-pdf-button" class="button" href="<?php echo JRoute::_('index.php?option=com_lawfirm&task=lawfirmpartner.generatepdf&id=' . (int)$this->item->id); ?>" target = "_blank"><?php echo "Save as PDF";?></a>
</div>
