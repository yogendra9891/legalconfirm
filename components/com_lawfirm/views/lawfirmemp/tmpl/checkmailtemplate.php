...
$.msgBox({
    title:"Alert",
    content:"Please select the partner first before edting the mail template."
});
...
<?php if($is_readybyemp == 1){?>
<p class="err">Submitted for approval</p>
<?php } else {?>
<!--<input class="button" type="submit" value="save" name="save" />-->
<input class="button" type="submit" value="Save for Partner Preview" name="partnersave" onclick="return validateFormsavetopartner('register1');"/> 
<?php } ?>
...
<input type="hidden" name="task" value="lawfirmemp.uploadpdf" /> 
...
<?php echo JHtml::_( 'form.token' ); ?>
	...
	?>
<div id="mailtemplate">
<h4>Edit the template.</h4>
<form method="post" name="register2" id="register2" action="index.php" onsubmit="return validateForm('register2');"><?php 
...
<p class="err">Submitted for approval</p>
<?php } else {?>
<input class="button" type="submit" value="Save" name="save" onclick="return validateFormsave('register2');"/> 
<input class="button" type="submit" value="Save for Partner review" name="partnersave" onclick="return validateFormsavetopartner('register2');"/> 
<?php } ?>
</div>
<input type="hidden" name="option" value="com_lawfirm" /> 
<input type="hidden" name="partner_id1" id = "partner_id1" value="" /> 
...
<input type="hidden" name="aid" value="<?php echo $aid; ?>" /> 
<input type="hidden" name="type" value="custom" /> 
<input type="hidden" name="task" value="lawfirmemp.addcustomhtml" /> 
<?php echo JHtml::_( 'form.token' ); ?>
</form>
</div>
<?php } ?></div>
