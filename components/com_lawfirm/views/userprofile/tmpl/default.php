...
<?php if(!in_array($this->item[groupId],$allow_group_id)){ ?> <a
...
&nbsp;&nbsp;|&nbsp; <a
	...
	&nbsp;&nbsp;|&nbsp; <a href="<?php echo JRoute::_('index.php?option=com_lawfirm&view=userprofile&layout=changeadmin&tmpl=component');?>"
		class="modal" rel="{handler: 'iframe', size: {x: 550,y: 240}}"><?php echo JText::_('COM_LAWFIRM_CHANGE_ADMIN'); ?></a>
<?php }elseif($this->item[groupId] == $lawfirm_emp){
	?>
	<a
	href="<?php echo JRoute::_('index.php?option=com_lawfirm&view=lawfirmemp');?>">Dashboard</a>
	<?php 
} elseif($this->item[groupId] == $lawfirm_partner){
	?>
	<a
	href="<?php echo JRoute::_('index.php?option=com_lawfirm&view=lawfirmpartner');?>">Dashboard</a>
	<?php 
}?></div>
...
<table>
	<tr>
		...
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_LAW_FIRM'); ?></td>
				<td><input type="text" name="personal[firm]"
					value="<?php echo $this->item['personalinfo']->accounting_firm; ?>"
					<?php if($gid != $lawfirm){echo "readonly='readonly'";}?> class="inputbox required" /></td>
			</tr>
		</table>
		</td>
		<td>
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_EMPNAME'); ?></td>
	...
	<tr>
		...
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_EMAIL'); ?></td>
		...
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_EMPTITLE'); ?></td>
	...
	<tr>
		...
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_EMPPHONE'); ?></td>
		...
		<table>
			<tr>
				...
				<td><?php echo JText::_('COM_LAWFIRM_PASSWORD'); ?></td>
	...
	<tr>
		...
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_CONFIRM_PASSWORD'); ?></td>
				<td><input type="password" name="personal[password2]" value=""
					class="inputbox" id="password2"/><div class="err" id="passerr"></div></td>
			</tr>
		</table>
		</td>
		<td>
...
<table>
	<tr>
		...
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_OFFICE_TITLE'); ?></td>
		...
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_ADDRESS'); ?></td>
	...
	<tr>
		...
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_CITY'); ?></td>
	...
	<tr>
		...
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_ZIP'); ?></td>
		...
		<table>
			<tr>
				...
				<td><input type="text" name="state"
					value="<?php echo $this->item['paymentInfo']->state; ?>"
					class="inputbox required" /></td>
			</tr>
		</table>
		</td>
		...
		<table>
			<tr>
				...
				<td><input type="text" name="country"
					value="<?php echo $this->item['paymentInfo']->country; ?>"
					class="inputbox required" /></td>
			</tr>
		</table>
		</td>
...
<?php } ?> <input type="submit" name="submit" value="Save"
	...
	value="com_lawfirm" /> <input type="hidden" name="personal[gid]"
