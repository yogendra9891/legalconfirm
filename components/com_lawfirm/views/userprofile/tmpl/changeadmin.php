...
<table>
	<tr>
		...
		<table>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_NEWADMIN_NAME'); ?></td>
				<td><input type="text" name="personal[name]"
					value=""
					class="inputbox required" /></td>
			</tr>
			<tr>
				<td><?php echo JText::_('COM_LAWFIRM_NEWADMIN_EMAIL'); ?></td>
				<td><input type="text" name="personal[email]"
					value=""
					 class="inputbox required" /><?php echo  strstr($this->item['personalinfo']->email,'@'); ?><br/><span class="err" id="emailerr1"></span></td>
			</tr>
		</table>
		</td>
		<td>
