...
//			 
            ...
            $office_activation_url = $data['siteurl'].'index.php?option=com_legalconfirm&task=auditoradmin.activateoffice&token='.$office_activation;
			
			$subject = "Account detail for ".$data['name']." at ".$data['sitename'];
			$to_email = $auditor_admin_email;
			$mailfrom = $data['mailfrom'];
			$fromname = $data['fromname'];
			$text = "Hello ".$auditor_admin_name.",<br /><br />New employee ".$data['username']." registered at LegalConfirm. Account must be activated before they can use it.
